...
if crossroad.lower() == "left":
    lake = input('You come to a lake. There is a an island in the middle of the lake.'
                 'Type "wait" to wait for a boat. Type "swim" to swim across.\n')
    if lake.lower() == "wait":
        island = input('You arrive at the island unharmed. There is a house with 3 doors. One red'
